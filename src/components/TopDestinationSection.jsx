...
const destinations = [
  ...
  },
  {
    id: "4",
    name: "Ayodhya",
    image: "/assets/images/Destinations/ram.jpg",
  ...
  },
  {
    ...
    description: "Experience the spiritual essence of Kumbh Mela 2025 in Prayagraj, where faith meets tradition."
  },
];
        ...
        {isDesktop ? (
          ...
          <Slider {...settings}>
            {destinations.map((destination, index) => (
              <Link to={`/listings/${destination.id}`} key={destination.id}>
                <motion.div
